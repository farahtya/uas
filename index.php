...
<body>
    ...
    <main>
         <article class="card">
                <marquee><h3 style="color:royalblue;">Selamat Datang di Zoeyaskin</h3></marquee>
            </article>
        <div id="content">
            ...
            <article class="card">
                ...
                <center>
                    ...
                    <p><span style="color:royalblue;">0311262412</span> An. Zoeyaskin</p>
                    <hr width="25%">
                    <br>
                </center>
                <center>
                    <img src="images/mandiri.PNG" alt="mandiri" width="25%">
                    <p><span style="color:royalblue;">44100238762</span> An. Zoeyaskin</p>
                    <hr width="25%">
                    <br>
                </center>
                <center>
                    <img src="images/btn.PNG" alt="btn" width="25%">
                    <p><span style="color:royalblue;">3100276363</span> An. Zoeyaskin</p>
                    <hr width="25%">
                    <br>
                </center>
                <center>
                    <img src="images/bri.PNG" alt="bri" width="25%">
                    <p><span style="color:royalblue;">3102884864</span> An. Zoeyaskin</p>
                </center>
            </article>
            <article class="card">
